...
public abstract class ElementUtils {
	public static boolean isOverlappingElements(Element element1,
			Element element2) {
	...
	public static Rectangle2D getElementRectangle(Element element) {
		return new Rectangle2D(element.getAbsoluteLeft(),
				element.getAbsoluteTop(), element.getAbsoluteRight(),
	...
	public static final native void sandpaperSetRotation(Element element,
			int degrees) /*-{
